...
void loop()
{
  ...
  pitch1 = 0 ; //compass1.getPitch();
  roll1 = 0; // compass1.getRoll();

  // Read the compass gyro
  gyrox1 = 0; //compass1.getGyroX() * compass1._gyroScale;
  gyroy1 = 0; //compass1.getGyroY() * compass1._gyroScale;
  gyroz1 = 0; //compass1.getGyroZ() * compass1._gyroScale;

  // Read the compass accelerator
  accelx1 = 0; //compass1.getAcceleroX() * compass1._accelScale;
  accely1 = 0; //compass1.getAcceleroY() * compass1._accelScale;
  accelz1 = 0; //compass1.getAcceleroZ() * compass1._accelScale;
  ...
  if (dataFile)
  {
    dataFile.print("micromagic16,$TMR,");
