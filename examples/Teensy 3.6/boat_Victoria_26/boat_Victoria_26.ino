...
// be7d0702-534a-49e1-b59c-19c9eea9ce3f
// 
...
void loop()
{
  ...
  // Special for the Victoria
  sail = ch2;
  if (sail < 30) { sail = 30;}
  if (sail > 130) {sail = 130;}
  ...
  Serial.print(",");
  Serial.print(mywind.mean);
  Serial.print(",");
  Serial.print(mywind.stdev);
  Serial.print(",");
  Serial.print(mywind.msg);
  Serial.print(",");
  ...
  if (dataFile)
  {
    ...
    dataFile.print(",$WLS,");
    dataFile.print(myrudder.wls.slope, 8);
    dataFile.print(",");
    dataFile.print(myrudder.wls.intercept, 8);
    dataFile.print(",");
    dataFile.print(myrudder.gyro.slope, 8);
    dataFile.print(",");
    dataFile.print(myrudder.gyro.intercept, 8);
    dataFile.print(",$LINE,");
