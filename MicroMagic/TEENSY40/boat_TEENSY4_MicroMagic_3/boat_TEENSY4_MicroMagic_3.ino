...
void loop()
{
  ...
  if (abs(mytime - lasttime) > 1000)
  {
    ...
    WiFiMessage = "<html><meta http-equiv=\"refresh\" content=\"1; URL=http://192.168.4.1\"><h1>Micro Magic Boat</h1>";
    WiFiMessage = WiFiMessage + "<h1>Time " + mytime + "</h1>";
    WiFiMessage = WiFiMessage + "<h1>Bearing " + BoatHeading + "</h1>";
    WiFiMessage = WiFiMessage + "<h2>Pitch " + pitch + "</h2>";
    WiFiMessage = WiFiMessage + "<h2>Roll " + roll + "</h2>";
    sprintf(strNumber,"%.8f",gps.latitude);
    WiFiMessage = WiFiMessage + "<h1>Latitude " + strNumber + "</h1>";
    sprintf(strNumber,"%.8f",gps.longitude);
    WiFiMessage = WiFiMessage + "<h1>Longitude " + strNumber + "</h1>";
    WiFiMessage = WiFiMessage + "<h1>Satelites " + gps.numsatelites + "</h1>";
    WiFiMessage = WiFiMessage + "<h2>Ch1 " + ch1 + "</h2>";
    WiFiMessage = WiFiMessage + "<h2>Ch2 " + ch2 + "</h2>";
    WiFiMessage = WiFiMessage + "<h2>Ch3 " + ch3 + "</h2>";
    WiFiMessage += "</html>\n";
  
    Serial2.print(WiFiMessage);
  }
  ...
  if (dataFile)
  {
    dataFile.print("MicroMagic4,$TMR,");
