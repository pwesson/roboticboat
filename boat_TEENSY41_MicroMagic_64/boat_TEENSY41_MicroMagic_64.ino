...
// Copyright (C) 2026
// f3d5c718-b94f-4b15-a563-8e341c7f8f97
//
...
void updateLogging() {
    ...
    // Update the User
    sprintf(sdbuffer, "MicroMagic64,$TMR,%lu,$RC,%d,%d,%d,$CMP,%.0f,%d,%d,%c%c%c%c%c%c%c%c,$ACC,%.3f,%.3f,%.3f,$GYR,%.3f,%.3f,%.3f,$GPS,%.0f,%.0f,%.8f,%c,%.8f,%c,%.1f,%d,%d,%.2f,%.2f,%c,%.0f,$HALL,%d,$BNO,%.0f,%.0f,%.0f,%.1f,%.1f", 
                      millis(),ch1,ch2,ch3,
