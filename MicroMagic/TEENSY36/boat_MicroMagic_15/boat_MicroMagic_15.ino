...
signed char pitch1 = 0;
signed char roll1 = 0;

signed char pitch2 = 0;
signed char roll2 = 0;
...
void setup()
{
  ...
  // Position fix update rate 1MHz
  // Send setup command to the GPS module
  // The update interval is in milliseconds (ms)
  Serial1.println("$PMTK220,1000*1F");
  delay(100);

  // Initialize the compass and initial readings
  compass1.beginI2C(0, 100000);
  delay(100);
  compass1.beginCMPS11(0x60, 0);
  delay(100);
  compass2.beginCMPS11(0x62, 0);
...
void loop()
{
  ...
  pitch1 = compass1.getPitch();
  roll1 = compass1.getRoll();

  // Read the compass gyro
  gyrox1 = compass1.getGyroX() * compass1._gyroScale;
  gyroy1 = compass1.getGyroY() * compass1._gyroScale;
  gyroz1 = compass1.getGyroZ() * compass1._gyroScale;

  // Read the compass accelerator
  accelx1 = compass1.getAcceleroX() * compass1._accelScale;
  accely1 = compass1.getAcceleroY() * compass1._accelScale;
  accelz1 = compass1.getAcceleroZ() * compass1._accelScale;

  delay(10);
  
  BoomHeading = compass2.getBearing();
  if (BoomHeading <0){
    scanI2C();
  }
  
  pitch2 = compass2.getPitch();
  roll2 = compass2.getRoll();

  // Read the compass gyro
  gyrox2 = compass2.getGyroX() * compass2._gyroScale;
  gyroy2 = compass2.getGyroY() * compass2._gyroScale;
  gyroz2 = compass2.getGyroZ() * compass2._gyroScale;

  // Read the compass accelerator
  accelx2 = compass2.getAcceleroX() * compass2._accelScale;
  accely2 = compass2.getAcceleroY() * compass2._accelScale;
  accelz2 = compass2.getAcceleroZ() * compass2._accelScale;
  ...
  myrudder.GyroUpdateMean(BoatHeading, gyroz1);

  myrudder.AddGyroReading(rudder, gyroz1);

  //Want to update the Wind direction estimate
  mywind.Update(BoatHeading, roll1);
  ...
  Serial.print(roll1);
  Serial.print("\t$CMP2,");
  Serial.print(BoomHeading);
  Serial.print(",");
  Serial.print(pitch2);
  Serial.print(",");
  Serial.print(roll2);
  Serial.print("\t$GYR,");
  Serial.print(gyrox1, 4);
  Serial.print(",");
  Serial.print(gyroy1, 4);
  Serial.print(",");
  Serial.print(gyroz1 - myrudder.gyrozmean, 4);
  Serial.print(",");
  ...
  if (dataFile)
  {
    dataFile.print("micromagic15,$TMR,");
    ...
    dataFile.print(",");
    dataFile.print(pitch1);
    dataFile.print(",");
    dataFile.print(roll1);
    dataFile.print(",$ACC,");
    dataFile.print(accelx1, 4);
    dataFile.print(",");
    dataFile.print(accely1, 4);
    dataFile.print(",");
    dataFile.print(accelz1, 4);
    dataFile.print(",$GYR,");
    dataFile.print(gyrox1, 4);
    dataFile.print(",");
    dataFile.print(gyroy1, 4);
    dataFile.print(",");
    dataFile.print(gyroz1, 4);
    dataFile.print(",$CMP2,");
    dataFile.print(BoomHeading);
    dataFile.print(",");
    dataFile.print(pitch2);
    dataFile.print(",");
    dataFile.print(roll2);
    dataFile.print(",$ACC2,");
    dataFile.print(accelx2, 4);
    dataFile.print(",");
    dataFile.print(accely2, 4);
    dataFile.print(",");
    dataFile.print(accelz2, 4);
    dataFile.print(",$GYR2,");
    dataFile.print(gyrox2, 4);
    dataFile.print(",");
    dataFile.print(gyroy2, 4);
    dataFile.print(",");
    dataFile.print(gyroz2, 4);
    dataFile.print(",$GPS,");
