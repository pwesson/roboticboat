...
// 7f39eeb1-fa62-4c95-8f27-9bd762aa6bf6
//
...
void loop()
{
  ...
  {  
    ...
    sprintf(sdbuffer, "Seawind30,$TMR,%lu,0,$RC,%d,%d,%d,$CMP,%.0f,%d,%d,%c%c%c%c%c%c%c%c,$ACC,%f,%f,%f,$GYR,%f,%f,%f,$GPS,%.0f,%.0f,%.8f,%c,%.8f,%c,%.1f,%d,%d,%.2f,%.2f,%c,$WND,%d,$HALL,%d,%d", 
                      mytime,ch1,ch2,ch3,
