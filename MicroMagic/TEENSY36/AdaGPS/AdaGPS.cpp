...
// $GPGGA,130048.000,0000.0000,N,00000.0000,E,1,10,1.1,75.5,M,47.0,M,,0000*00
  ...
  if (strstr(gpsfields[0], "$GPGGA")) {
    ...
    if (strlen(gpsfields[1]) == 10)
    {
       timestr[0] = gpsfields[1][0];
       timestr[1] = gpsfields[1][1];
       timestr[2] = ':';
       timestr[3] = gpsfields[1][2];
       timestr[4] = gpsfields[1][3];
       timestr[5] = ':';
       timestr[6] = gpsfields[1][4];
       timestr[7] = gpsfields[1][5];
       timestr[8] = '\0';
    }
  }
}
...
//$GPRMC,111837.000,A,0000.0000,N,00000.0000,E,0.44,147.21,111015,,,A*6A
  ...
  if (strstr(gpsfields[0], "$GPRMC")) {
    ...
    if (strlen(gpsfields[9]) == 6)
    {
        datestr[0] = gpsfields[9][0];
        datestr[1] = gpsfields[9][1];
        datestr[2] = '/';
        datestr[3] = gpsfields[9][2];
        datestr[4] = gpsfields[9][3];
        datestr[5] = '/';
	datestr[6] = '2';
	datestr[7] = '0';
	datestr[8] = gpsfields[9][4];
	datestr[9] = gpsfields[9][5];
        datestr[10] = '\0';
    }
