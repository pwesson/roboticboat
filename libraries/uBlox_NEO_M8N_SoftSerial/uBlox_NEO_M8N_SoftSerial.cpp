...
uBlox_NEO_M8N_SoftSerial::uBlox_NEO_M8N_SoftSerial(SoftwareSerial *serialPort){
...
void uBlox_NEO_M8N_SoftSerial::listen(){
...
void uBlox_NEO_M8N_SoftSerial::read(char nextChar){
...
bool uBlox_NEO_M8N_SoftSerial::CheckSum(char* msg) {
...
float uBlox_NEO_M8N_SoftSerial::DegreeToDecimal(float num, byte sign)
{
...
void uBlox_NEO_M8N_SoftSerial::parseString(char* msg) {
...
void uBlox_NEO_M8N_SoftSerial::messageGGA(char* msg) 
{
...
void uBlox_NEO_M8N_SoftSerial::messageRMC(char* msg) 
{
...
// Convert HEX to DEC
int uBlox_NEO_M8N_SoftSerial::Hex2Dec(char c) {
...
void uBlox_NEO_M8N_SoftSerial::AllSentences()
{
...
void uBlox_NEO_M8N_SoftSerial::SelectSentences()
{
  // NMEA_GLL output interval - Geographic Position - Latitude longitude
  // NMEA_RMC output interval - Recommended Minimum Specific GNSS Sentence
  // NMEA_VTG output interval - Course Over Ground and Ground Speed
...
void uBlox_NEO_M8N_SoftSerial::SelectGGAonly()
{
  // NMEA_GLL output interval - Geographic Position - Latitude longitude
  // NMEA_RMC output interval - Recommended Minimum Specific GNSS Sentence
  // NMEA_VTG output interval - Course Over Ground and Ground Speed
