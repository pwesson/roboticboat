...
void loop()
{
  ...
  WiFiMessage = WiFiMessage + "<h1>Pitch " + pitch + "</h1>";
  WiFiMessage = WiFiMessage + "<h1>Roll " + roll + "</h1>";
  //sprintf(strNumber,"%.8f",gps.latitude);
  //WiFiMessage = WiFiMessage + "<h1>Latitude " + strNumber + "</h1>";
  WiFiMessage = WiFiMessage + "<h1>Longitude " + gps.longitude + "</h1>";
  ...
  if (dataFile)
  {
    dataFile.print("MicroMagic2,$TMR,");
